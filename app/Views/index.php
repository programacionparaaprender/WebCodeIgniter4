                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/lamp-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/lamp-400.jpg 1x, images/thumbs/post/lamp-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/tulips-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/tulips-400.jpg 1x, images/thumbs/post/tulips-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/music-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/music-400.jpg 1x, images/thumbs/post/music-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/watch-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/watch-400.jpg 1x, images/thumbs/post/watch-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/wheel-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/wheel-400.jpg 1x, images/thumbs/post/wheel-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/guitarist-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/guitarist-400.jpg 1x, images/thumbs/post/guitarist-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/jump-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/jump-400.jpg 1x, images/thumbs/post/jump-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/flowers-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/flowers-400.jpg 1x, images/thumbs/post/flowers-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/woodcraft-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/woodcraft-400.jpg 1x, images/thumbs/post/woodcraft-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/fuji-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/fuji-400.jpg 1x, images/thumbs/post/fuji-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/beetle-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/beetle-400.jpg 1x, images/thumbs/post/beetle-800.jpg 2x" alt="">
                            </a>
                        </div>
                        ...
                        <div class="item-entry__thumb">
                            <a href="single-standard.html" class="item-entry__thumb-link">
                                <img src="<?= base_url() ?>/assets/images/thumbs/post/sydney-400.jpg" 
                                     srcset="<?= base_url() ?>/assets/images/thumbs/post/sydney-400.jpg 1x, images/thumbs/post/sydney-800.jpg 2x" alt="">
                            </a>
                        </div>
